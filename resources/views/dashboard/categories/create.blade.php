...
<div class="flex min-h-screen bg-gray-100">
    <div class="flex-1 ml-64 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-700">Create New Category</h1>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="box-shadow rounded-lg p-6 bg-white">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full p-2 border rounded-lg" value="{{ old('name') }}" required>
                    @error('name')
