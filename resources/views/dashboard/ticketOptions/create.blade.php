...
<div class="flex min-h-screen bg-gray-100">
    ...
    <div class="flex-1 ml-64 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-700">Create Ticket Option</h1>
        </div>
        ...
        <form action="{{ route('ticketOptions.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="refund_policy" class="w-full p-2 border rounded-lg"></textarea>
                </div>
