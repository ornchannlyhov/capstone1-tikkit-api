...
<div class="p-6 bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-2xl bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <input type="text" name="firstname" value="{{ $user->firstname }}" class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-gray-400" required>

            <label class="block mt-4 mb-2 text-gray-700">Last Name</label>
            <input type="text" name="lastname" value="{{ $user->lastname }}" class="w-full p-2 border rounded-lg focus:ring-2 focus:ring-gray-400" required>
