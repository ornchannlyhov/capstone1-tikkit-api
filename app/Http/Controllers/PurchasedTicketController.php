...
{
    // Store a purchased ticket (web route) will call after payment success 
    ...
    // View purchased tickets for the buyer (API route)
    ...
    // Admin: View purchased tickets for a specific ticket option (Web route)
